...
#
#  PURPOSE: Generate data for simulation study
#
#  INPUT:   None
#
#  OUTPUT:  simdat{X}.RData
#
#  NOTES:   The simulated data are stored in sixteen files, with each file
...
for (i in 1:nrow(settings)) {
  ...
  save(dat, file = here("Data", paste0("simdat", i, ".RData")))
}
